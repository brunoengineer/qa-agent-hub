---
name: PR Review
description: Review a GitHub Pull Request and return an approval-risk report with actionable inline comments
tools:
  - createFile
---
...
- `.github/instructions/automation.instructions.md` when the diff contains test code.
- `.github/instructions/test-design.instructions.md` when the diff adds, modifies, or should have added tests.
...
When input is provided, review the PR as a senior code reviewer and return a concise approval-risk report with actionable inline review comments.
...
When (and only when) input is provided and you generate the review report:
...
6. Do not create any file when no input was provided.
